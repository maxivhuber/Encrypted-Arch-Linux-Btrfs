...
pacstrap /mnt base base-devel linux linux-headers  linux-firmware  \textcolor{red}{\text{ intel-ucode}} bash-completion btrfs-progs dosfstools grub efibootmgr nano cryptsetup
...
\item pacman -S xorg-server xorg-xinit ttf-dejavu \textcolor{red}{\text{xfce4 xfce4-goodies}} lightdm \textcolor{red}{\text{ lightdm-webkit2-greeter nvidia}}  networkmanager network-manager-applet nm-connection-editor alsa alsa-tools alsa-utils pulseaudio-alsa pavucontrol cronie avahi acpid
